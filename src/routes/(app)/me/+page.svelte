...
<div class="mt-10 flex flex-col gap-2">
	...
	<Card.Root>
		...
		<Card.Content>
									...
									<DropdownMenu.Root>
										...
										<DropdownMenu.Content>
											<DropdownMenu.Item href="/me/links/{link.id}" class="gap-2">
												<IconChartHistogram size={14} stroke={1} />
												Analytics
											</DropdownMenu.Item>
											<DropdownMenu.Item href="/me/links/{link.id}/edit" class="gap-2">
												<IconEdit size={14} stroke={1} />
												Edit
											</DropdownMenu.Item>
											<DropdownMenu.Item href="/me/links/{link.id}/delete" class="gap-2">
												<IconTrash size={14} stroke={1} />
												Delete
											</DropdownMenu.Item>
										</DropdownMenu.Content>
									</DropdownMenu.Root>
			...
			{:else}
				<p class="text-muted-foreground">You haven't created any links yet.</p>
